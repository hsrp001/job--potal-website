...
const Navbar = () => {
 ...
 const{data, userdata , logout ,post ,jobCount, setJobCount , setchatsocket}= useContext(MyContext)
...
/>
    ...
    <Link  to={`/userdashboard`} class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">User Dashbord</Link>
...
/>
  ...
  <div class={`absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none  ${profile ? 'block':"hidden"}   `} role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
    ...
    <Link  to={`/companydashboard`} class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Company Dashbord</Link>
